...
import com.blogapp.postservice.service.CommentService;
...
public class CommentRestController {
	...
	public ResponseEntity<Comment> createComment(@RequestBody Comment commentDto ,@PathVariable Integer postId){
		Comment createComment = this.commentService.createComment(commentDto, postId);
